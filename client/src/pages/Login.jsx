...
const Login = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap items-center" bis_skin_checked="1">
    <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0" bis_skin_checked="1">
      <h1 className="title-font font-medium text-3xl text-gray-900">Slow-carb next level shoindcgoitch ethical authentic, poko scenester</h1>
      <p className="leading-relaxed mt-4">Poke slow-carb mixtape knausgaard, typewriter street art gentrify hammock starladder roathse. Craies vegan tousled etsy austin.</p>
    </div>
    <form onSubmit={onSubmitHandler} className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0" bis_skin_checked="1">
      ...
      <Link to={"/register"}
       className="text-xs text-gray-500 mt-3">Don't have an account?</Link>
    </form>
  </div>
</section>
    </div>
